...
def lu_factorize_handle_pivoting_tridiag_arrowhead(
...
def lu_factorize_inverse_tip_tridiag_arrowhead(
    A_diagonal_blocks: np.ndarray,
    A_lower_diagonal_blocks: np.ndarray,
    A_upper_diagonal_blocks: np.ndarray,
    A_arrow_bottom_blocks: np.ndarray,
    ...
    L_arrow_bottom_blocks[:, -arrow_blocksize:] = A_arrow_tip_block[:, :]
