...
def lu_sinv_tridiag_arrowhead(
    ...
    for i in range(n_diag_blocks - 2, -1, -1):
        ...
        X[
            i * diag_blocksize : (i + 1) * diag_blocksize, (i + 1) * diag_blocksize : (i + 2) * diag_blocksize
        ] = U_blk_inv @ (
            -U[i * diag_blocksize : (i + 1) * diag_blocksize, (i + 1) * diag_blocksize : (i + 2) * diag_blocksize]
            @ X[
                (i + 1) * diag_blocksize : (i + 2) * diag_blocksize, (i + 1) * diag_blocksize : (i + 2) * diag_blocksize
            ]
        ...
        X[i * diag_blocksize : (i + 1) * diag_blocksize, -arrow_blocksize:] = U_blk_inv @ (
            -U[i * diag_blocksize : (i + 1) * diag_blocksize, (i + 1) * diag_blocksize : (i + 2) * diag_blocksize]
            @ X[(i + 1) * diag_blocksize : (i + 2) * diag_blocksize, -arrow_blocksize:]
            - U[i * diag_blocksize : (i + 1) * diag_blocksize, -arrow_blocksize:]
            @ X[-arrow_blocksize:, -arrow_blocksize:]
        ...
        X[i * diag_blocksize : (i + 1) * diag_blocksize, i * diag_blocksize : (i + 1) * diag_blocksize] = (
            U_blk_inv
            - X[i * diag_blocksize : (i + 1) * diag_blocksize, (i + 1) * diag_blocksize : (i + 2) * diag_blocksize]
            @ L[(i + 1) * diag_blocksize : (i + 2) * diag_blocksize, i * diag_blocksize : (i + 1) * diag_blocksize]
...
def lu_sinv_ndiags(
    ...
    for i in range(nblocks - 1, -1, -1):
        ...
        for j in range(min(i + n_offdiags_blk, nblocks - 1), i, -1):
            ...
            X[i * blocksize : (i + 1) * blocksize, j * blocksize : (j + 1) * blocksize] = (
                U_blk_inv @ X[i * blocksize : (i + 1) * blocksize, j * blocksize : (j + 1) * blocksize]
            )
...
def lu_sinv_ndiags_arrowhead(
    ...
    for i in range(n_diag_blocks - 1, -1, -1):
        ...
        X[i * diag_blocksize : (i + 1) * diag_blocksize, -arrow_blocksize:] = (
            U_blk_inv @ X[i * diag_blocksize : (i + 1) * diag_blocksize, -arrow_blocksize:]
        )
        ...
        for j in range(min(i + n_offdiags_blk, n_diag_blocks - 1), i, -1):
            ...
            X[i * diag_blocksize : (i + 1) * diag_blocksize, j * diag_blocksize : (j + 1) * diag_blocksize] = (
                -U[i * diag_blocksize : (i + 1) * diag_blocksize, -arrow_blocksize:]
            ...
            for k in range(i + 1, min(i + n_offdiags_blk + 1, n_diag_blocks), 1):
                ...
                X[i * diag_blocksize : (i + 1) * diag_blocksize, j * diag_blocksize : (j + 1) * diag_blocksize] -= (
                    U[i * diag_blocksize : (i + 1) * diag_blocksize, k * diag_blocksize : (k + 1) * diag_blocksize]
                    @ X[k * diag_blocksize : (k + 1) * diag_blocksize, j * diag_blocksize : (j + 1) * diag_blocksize]
                )
        ...
        for k in range(i + 1, min(i + n_offdiags_blk + 1, n_diag_blocks), 1):
            # X_{i, i} = X_{i, i} - X_{i, k} L_{k, i}
            X[i * diag_blocksize : (i + 1) * diag_blocksize, i * diag_blocksize : (i + 1) * diag_blocksize] -= (
                X[i * diag_blocksize : (i + 1) * diag_blocksize, k * diag_blocksize : (k + 1) * diag_blocksize]
                @ L[k * diag_blocksize : (k + 1) * diag_blocksize, i * diag_blocksize : (i + 1) * diag_blocksize]
            )
