...
def lu_sinv_ndiags(
    ...
    X = np.empty(L.shape, dtype=L.dtype)

    L_blk_inv = np.empty((blocksize, blocksize), dtype=L.dtype)
    U_blk_inv = np.empty((blocksize, blocksize), dtype=L.dtype)
...
def lu_sinv_ndiags_arrowhead(
    ...
    L_last_blk_inv = np.empty((arrow_blocksize, arrow_blocksize), dtype=L.dtype)
    U_last_blk_inv = np.empty((arrow_blocksize, arrow_blocksize), dtype=L.dtype)
    ...
    L_blk_inv = np.empty((diag_blocksize, diag_blocksize), dtype=L.dtype)
    U_blk_inv = np.empty((diag_blocksize, diag_blocksize), dtype=L.dtype)
