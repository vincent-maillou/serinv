...
def test_lu_dist_top_process(
    ...
    reduced_system[0:diag_blocksize, 0:diag_blocksize] = A_diagonal_blocks[:, -diag_blocksize:]
    ...
    X_sdr_diagonal_blocks[:, -diag_blocksize:] = reduced_system_inv[0:diag_blocksize, 0:diag_blocksize]
