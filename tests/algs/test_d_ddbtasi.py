...
from serinv.algs import d_ddbtaf, d_ddbtasi, d_ddbtasi_rss
...
def test_d_pobtasi(
    ...
    (
        ...
        L_upper_diagonal_blocks_local,
        L_arrow_bottom_blocks_local,
        L_arrow_right_blocks_local,
    ...
    if device_array:
        ...
        assert X_upper_diagonal_blocks_local.data == A_upper_diagonal_blocks_local.data

        assert X_arrow_bottom_blocks_local.data == A_arrow_bottom_blocks_local.data
        assert X_arrow_right_blocks_local.data == A_arrow_right_blocks_local.data
        ...
        assert (
            X_upper_diagonal_blocks_local.ctypes.data
        ...
        assert (
            X_arrow_right_blocks_local.ctypes.data
