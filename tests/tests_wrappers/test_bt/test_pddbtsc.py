...
def test_pddbtsc(
    ...
    if comm_rank == 0:
        print(f"{comm_rank}, X_ref_diagonal_blocks_local: {X_ref_diagonal_blocks_local}", flush=True)
        print(f"{comm_rank}, ddbtrs[A_diagonal_blocks]: {ddbtrs["A_diagonal_blocks"]}", flush=True)
        # print(f"{comm_rank}, ddbtrs[A_lower_diagonal_blocks]: {ddbtrs["A_lower_diagonal_blocks"]}", flush=True)
