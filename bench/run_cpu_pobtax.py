...
if __name__ == "__main__":
    ...
    tic = time.perf_counter()
    A_diagonal_blocks = np.zeros_like(A_diagonal_blocks_init)
    A_lower_diagonal_blocks = np.zeros_like(A_lower_diagonal_blocks_init)
    A_arrow_bottom_blocks = np.zeros_like(A_arrow_bottom_blocks_init)
