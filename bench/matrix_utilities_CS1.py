...
class ColorScheme:
    ...
    background: ArrayLike = field(default_factory=lambda: np.array([248, 239, 220]) / 255)
    A_elements: ArrayLike = field(default_factory=lambda: np.array([115, 110, 102]) / 255)
    P_elements: ArrayLike = field(default_factory=lambda: np.array([74, 144, 164]) / 255)
    fillin_hatching: ArrayLike = field(
        default_factory=lambda: np.array([255, 0, 0]) / 255
    )
    factor_elements: ArrayLike = field(
        default_factory=lambda: np.array([180, 170, 155]) / 255
    )
    boundary_elements: ArrayLike = field(
        default_factory=lambda: np.array([163, 183, 198]) / 255
    )
    inverse_elements: ArrayLike = field(
        default_factory=lambda: np.array([140, 44, 22]) / 255
    )
