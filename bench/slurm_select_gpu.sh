...
srun --cpu-bind=${CPU_BIND} --mpi=pmi2 python benchmark_select_gpu.py --diagonal_blocksize $DIAGONAL_BLOCKSIZE --arrowhead_blocksize $ARROWHEAD_BLOCKSIZE --n_diag_blocks $N_DIAG_BLOCKS --n_iterations $N_ITERATIONS --n_warmups $N_WARMUPS --file_path $FILE_PATH --n_tasks_per_node 2 --gpus 7 3
